...
Example:
    pipeline = AssetBasedPipeline(reel_video)
...
from reel_video.pipelines.linear import LinearVideoPipeline, PipelineContext
...
class AssetBasedPipeline(LinearVideoPipeline):
    ...
    async def __call__(
        ...
        **kwargs
        ...
        """
        from reel_video.pipelines.linear import PipelineContext
    ...
    async def generate_content(self, context: PipelineContext) -> PipelineContext:
        ...
        """
        from reel_video.prompts.asset_script_generation import build_asset_script_prompt
    ...
    async def produce_assets(self, context: PipelineContext) -> PipelineContext:
        ...
        for i, frame in enumerate(storyboard.frames, 1):
            ...
            if len(narration_audios) > 1:
                from reel_video.utils.os_util import get_task_frame_path
