...
from reel_video.pipelines.base import BasePipeline
from reel_video.models.progress import ProgressEvent
from reel_video.models.storyboard import (
    Storyboard,
    StoryboardFrame,
    StoryboardConfig,
    ContentMetadata,
...
class CustomPipeline(BasePipeline):
    ...
    Example usage:
        ...
        reel_video.pipelines["my_custom"] = CustomPipeline(reel_video)
    ...
    async def __call__(
        ...
        from reel_video.utils.os_util import (
        ...
        from reel_video.utils.template_util import resolve_template_path, get_template_type
        ...
        from reel_video.utils.content_generators import generate_title
        ...
        # from reel_video.utils.content_generators import generate_narrations_from_topic
        ...
        if template_requires_image:
            ...
            from reel_video.utils.content_generators import generate_image_prompts
...
# Use immediately
reel_video.pipelines["quick"] = QuickPipeline(reel_video)
result = await reel_video.generate_video(text=content, pipeline="quick")
"""
