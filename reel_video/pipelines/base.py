...
from reel_video.models.storyboard import VideoGenerationResult
...
class BasePipeline(ABC):
    ...
    def __init__(self, reel_video_core):
        """
        Initialize pipeline with core services
        
        Args:
            reel_video_core: ReelVideoCore instance (provides access to all services)
        """
        self.core = reel_video_core
        
        # Quick access to services (convenience)
        self.llm = reel_video_core.llm
        self.tts = reel_video_core.tts
        self.media = reel_video_core.media
        self.video = reel_video_core.video
        
        # Backward compatibility alias
        self.image = reel_video_core.media
