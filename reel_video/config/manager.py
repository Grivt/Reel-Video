...
from .schema import ReelVideoConfig
...
class ConfigManager:
    ...
    def __init__(self, config_path: str = "config.yaml"):
        ...
        self.config: ReelVideoConfig = self._load()
        self._initialized = True
    
    def _load(self) -> ReelVideoConfig:
        """Load configuration from file"""
        data = load_config_dict(str(self.config_path))
        config = ReelVideoConfig(**data)
    ...
    def update(self, updates: dict):
        ...
        self.config = ReelVideoConfig(**merged)
