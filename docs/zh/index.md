...
1. **[安装 Reel-Video](getting-started/installation.md)** - 下载并安装项目
   - 🪟 **Windows 用户推荐**: 使用 [一键整合包](https://github.com/AIDC-AI/Reel-Video/releases/latest)，无需安装 Python 环境
...
本项目采用 Apache 2.0 许可证，详情请查看 [LICENSE](https://github.com/AIDC-AI/Reel-Video/blob/main/LICENSE) 文件。
