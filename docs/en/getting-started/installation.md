...
This page will guide you through installing Reel-Video.
...
1. Visit [GitHub Releases](https://github.com/AIDC-AI/Reel-Video/releases/latest) to download the latest version
...
Your browser should automatically open `http://localhost:8501` and display the Reel-Video web interface.
