...
Video templates use HTML to define the layout and style of video frames. Reel-Video provides multiple preset templates covering different video dimensions and style requirements.
...
For template development questions, feel free to ask in [GitHub Issues](https://github.com/AIDC-AI/Reel-Video/issues).
