#!/usr/bin/env python3
"""
Windows Package Builder for Reel-Video
...
class WindowsPackageBuilder:
    """Build Windows portable package for Reel-Video"""
    ...
    def build(self):
        ...
        try:
            ...
            # Copy project files
            project_target = self.build_dir / "Reel-Video"
...
def main():
    parser = argparse.ArgumentParser(description="Build Windows portable package for Reel-Video")
    parser.add_argument(
        '--config',
